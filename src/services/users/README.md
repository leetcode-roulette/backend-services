...
## Features
This project allows users to retrieve user information from [leetcode](https://leetcode.com). 
...
Type: `String`
Default: `mongodb://localhost:27017/usersService`
