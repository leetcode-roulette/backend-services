...
// import QuestionsConsumer from "./kafka";

mongoose.set("strictQuery", false);

const serve = async () => {
	const PORT = process.env.PORT || 3000;
	const MONGO_CONNECTION_STRING = process.env.MONGO_CONNECTION_STRING || "mongodb://localhost:27017/questionsService";
	...
	// const consumer: QuestionsConsumer = new QuestionsConsumer({
